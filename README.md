...
# 🎯 목표
- 다양한 행사 정보 + 예술가에 대한 투자 기회 -> 둘을 합친 통합 플랫폼 제공
- 문화 예술의 접근성, 상업적 기회 ↑
...
# ❗ 느낀점
- 이 프로젝트를 진행하면서 많은 배움을 얻게 되었다. 프로젝트 중 예기치 못한 사정으로 조원 한 명이 프로젝트를 못하게 되었다. 이는 우리가 처음부터 계획한 것과는 다른 결과를 가져오게 되었다. 모든 기능들을 전부 구현은 못하였지만 완성할 수 있을 정도의 기능만 구현하여 완성을 목적으로 마무리하였다. 이 경험을 통해 돌발 상황에 대한 유연성의 중요성과 협력과 의사소통에 대한 중요성을 배울 수 있었다. 이 프로젝트를 토대로 더욱 성장할 수 있게 노력할 것이다.
